...
public class ProductService {
    ...
    public void saveProduct(Product product) {
        try { firestoreService.saveProduct(product); } catch (Exception e) { e.printStackTrace(); }
    }

    public Product getProductById(String id) {
        try { return firestoreService.getProductById(id); } catch (Exception e) { return null; }
    }
